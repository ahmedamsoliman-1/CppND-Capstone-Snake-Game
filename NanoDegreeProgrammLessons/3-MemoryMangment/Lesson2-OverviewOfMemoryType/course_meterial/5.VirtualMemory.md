...
5. Virtual Memory
                ...
                vide: C:\Users\ahmed\Desktop\MemMang\ND213 C03 L01 05.1 Smart Pointers HS.mp4
...
Diagram showing situation where physical memory is less than the upper bound imposed by the architecture.
...
Diagram showing virtual address space referencing RAM and hard disk.
...
Diagram showing two running processes and a collection of memory pages and frames.
...
In summary, virtual memory management is performed by the operating system and programmers do usually not interfere with this process. The major benefit is a unique perspective on a chunk of memory for each program that is only limited in its size by the architecture of the system (32 bit, 64 bit) and by the available physical memory, including the hard disk.
                ...
                vide: C:\Users\ahmed\Desktop\MemMang\ND213 C03 L01 05.2 Smart Pointers HS.mp4